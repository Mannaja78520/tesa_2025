...
# ---------- CONFIG ----------
DRONE_MODEL_PATH = "best.pt"
TEST_DIR = "P2_DATA_TRAIN/P2_DATA_TRAIN"
SAVE_DIR = "P2_DATA_TRAIN/TEST_RESULTS_SAHI"
CSV_PATH = "P2_DATA_TRAIN/output.csv"   # ไฟล์ CSV เก็บผลลัพธ์
